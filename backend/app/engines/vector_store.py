"""
VectorNet Vector Similarity Store & Machine Learning Loop Engine
================================================================
Implements cosine vector similarity and embedding matching for unknown/novel
vendor CLI commands. Writes newly trained syntax directly into dynamic markdown
skill profiles for zero-code hot reloading.
"""
...
from backend.app.core.models import VectorMappingRequest, VectorMappingResponse
...
class VectorStoreEngine:
    ...
    def train_rule_to_skill(self, vendor: str, cli_snippet: str, target_sbm_key: str, description: str = "") -> Dict[str, Any]:
        ...
        # Resolve path to skills/vendors
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        skills_dir = os.path.join(base_dir, "skills", "vendors")
        if not os.path.exists(skills_dir):
            skills_dir = os.path.join(base_dir, "backend", "skills", "vendors")
