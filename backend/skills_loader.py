...
from backend.models import (
    SecurityBaselineModel, AuditFinding, SeverityLevel, ComplianceStatus
)
...
class SkillProfile:
    def __init__(self, skill_id: str, skill_name: str, category: str, framework: str, filepath: str, raw_content: str):
