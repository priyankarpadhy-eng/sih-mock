...
class ComplianceEngine:
    ...
    @classmethod
    def evaluate_compliance(cls, baseline: SecurityBaselineModel, telemetry_logs: List[UnifiedJsonLog] = None) -> ComplianceSummary:
        ...
        if not skill_findings:
            ...
            access_ctrl = baseline.access_control
